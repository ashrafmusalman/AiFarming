...
import com.ashraf.farming.adapter.AddressAdapter
import com.ashraf.farming.adapter.BillingProductAdapter
import com.ashraf.farming.datamodel.Address
import com.ashraf.farming.datamodel.Order
import com.ashraf.farming.datamodel.OrderStatus
            ...
            billingViewmodel.placeOrder.collect {
                when (it) {
                    ...
                    is Resources.Success -> {
                        ...
                        findNavController().currentDestination?.id?.let { currentId ->
                            if (currentId == R.id.billingFragment) {
                                val navOptions = NavOptions.Builder()
                                    .setPopUpTo(R.id.billingFragment, true)
                                    .build()
