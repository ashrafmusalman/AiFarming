...
import com.ashraf.farming.adapter.CartItemAdapter
...
import com.ashraf.farming.viewmodel.CartItemViewmodel
...
class CartFragment : Fragment() {
    ...
    private fun observeDelete() {
        lifecycleScope.launch {
            cartViewmodel.deleteStatus.collect {// here we collect
                when (it) {
                    is Resources.Error -> {
